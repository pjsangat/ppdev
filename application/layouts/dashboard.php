...
<?php echo link_tag(ROOT_URL.'../../public/assets/themes/customized_theme/images/iconsfavicon.png', 'rel', 'Shortcut Icon', array("type"=>"image/x-icon")) ?>
...
<?php echo render_system_notices(logged_user()) ?>
    <div id="wrapper">
      ...
      <div id="headerWrapper">
        <div id="header">
          <h1><a href="<?php echo get_url('dashboard', 'index') ?>"><?php echo ($_SESSION['instance'] == "mf" ? '<img src="/public/assets/themes/customized_theme/images/layout/title-bg.png" />' : $site_name ); ?></a></h1>
