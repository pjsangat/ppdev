...
<?php if (!$task->isNew()) { ?>
  <div>
    <?php echo label_tag(lang('project - task list'), 'addTaskTaskList', true) ?>
    <?php echo select_task_list('task[task_list_id]', 'all', array_var($task_data, 'task_list_id'), false, array('id' => 'addTaskTaskList')) ?>
  </div>
<?php } // if ?>
